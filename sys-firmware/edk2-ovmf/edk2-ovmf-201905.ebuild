...
src_compile() {
	...
	edos2unix ./BaseTools/Conf/tools_def.template
	edos2unix ./BaseTools/Source/C/Makefiles/header.makefile
	patch -p1  < "${FILESDIR}"/clang-cflags.patch
	unix2dos ./BaseTools/Source/C/Makefiles/header.makefile
	unix2dos ./BaseTools/Conf/tools_def.template
	cp "${FILESDIR}/vrom.h" ./OvmfPkg/AcpiPlatformDxe/
	cp "${FILESDIR}/vrom_table.h" ./OvmfPkg/AcpiPlatformDxe/
	edos2unix ./OvmfPkg/AcpiPlatformDxe/QemuFwCfgAcpi.c
	patch -p1 < "${FILESDIR}/nvidia-hack.diff"
