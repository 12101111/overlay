...
LICENSE="LGPL-2.1+"
SLOT="0/0.3"
IUSE="bluetooth aptx aac debug doc ffmpeg gstreamer jack sdl sndfile systemd test vulkan X"
...
RDEPEND="
	...
	bluetooth? (
		media-libs/sbc
		net-wireless/bluez:=
		aac? ( >=media-libs/fdk-aac-2.0.1 )
		aptx? ( >=media-libs/libopenaptx-0.2.0 )
	)
...
src_configure() {
	...
	local emesonargs=(
		...
		-Dbluez5-codec-ldac=disabled #https://github.com/EHfive/ldacBT
