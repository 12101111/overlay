...
https://registry.yarnpkg.com/@types/node/-/node-12.19.2.tgz
...
PATCHES=(
	...
	"${FILESDIR}/0003-Allow-build-using-nodejs-14.patch"
	"${FILESDIR}/0004-Allow-offline-in-args.patch"
	"${FILESDIR}/0005-Add-install-script-for-Gentoo.patch"
	"${FILESDIR}/0006-Run-yarn-install-in-offline-mode.patch"
	"${FILESDIR}/0007-Don-t-download-bundle-marketplace-extensions-in-gulp.patch"
	"${FILESDIR}/0008-Don-t-run-yarn-install-for-web-remote-test.patch"
	"${FILESDIR}/0009-update-product.json.patch"
	"${FILESDIR}/0010-use-github-tar-ball-instead-of-git.patch"
)
