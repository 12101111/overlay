...
IUSE="big-endian clippy cpu_flags_x86_sse2 debug dist doc llvm-libunwind lto miri nightly parallel-compiler rustfmt rust-analyzer rust-src system-llvm test wasm sanitizers ${ALL_LLVM_TARGETS[*]}"
...
PATCHES=(
	...
	"${FILESDIR}"/1.84.0-fix-bootstrap.patch
)
