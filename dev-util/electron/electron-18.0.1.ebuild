...
SLOT="${PV%%[.+]*}"
KEYWORDS="~amd64"
IUSE="atk lto pgo component-build custom-cflags cups cpu_flags_arm_neon debug headless +js-type-check kerberos libcxx pic +proprietary-codecs pulseaudio screencast selinux +suid +system-ffmpeg +system-harfbuzz +system-icu +system-png vaapi wayland"
REQUIRED_USE="
