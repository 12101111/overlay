...
if [[ ${PV} == 9999 ]]; then
	...
	MY_PV=${PV/_rc/-rc}
	inherit verify-sig
	SRC_URI="https://github.com/swaywm/${PN}/releases/download/${MY_PV}/${PN}-${MY_PV}.tar.gz -> ${P}.gh.tar.gz
		https://github.com/swaywm/${PN}/releases/download/${MY_PV}/${PN}-${MY_PV}.tar.gz.sig -> ${P}.gh.tar.gz.sig"
